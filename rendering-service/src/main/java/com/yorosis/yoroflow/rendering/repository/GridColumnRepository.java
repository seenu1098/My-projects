...
public interface GridColumnRepository extends JpaRepository<GridColumns, UUID> {
	...
	public List<GridColumns> getGridColumnList(Pageable pageable, @Param("activeFlag") String flag,
	...
	public List<GridColumns> getGridColumns(@Param("gridName") String name, @Param("activeFlag") String flag,
			@Param("tenantId") String tenantId);
}
