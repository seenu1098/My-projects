...
public interface ApplicationPermissionsRepository extends JpaRepository<ApplicationPermissions, UUID> {
	...
	public int checkApplicationSecurityExist(@Param("applicationId") UUID appId, @Param("activeFlag") String flag,
			@Param("tenantId") String tenantId);

	public List<ApplicationPermissions> findByApplicationIdAndTenantIdIgnoreCaseAndActiveFlag(UUID pageId,
