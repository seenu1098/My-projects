...
public interface UserGroupRepository extends JpaRepository<UserGroup, UUID> {
	...
	public List<UserGroup> getUserGroups(@Param("userId") UUID userId, @Param("tenantId") String tenantId,
	...
	public List<UserGroup> getGroupIdAndUsernameAndTenantIdAndActiveFlagIgnoreCase(@Param("groupId") UUID groupId,
	...
	public Set<UUID> getUserIdByGroupIdList(@Param("groupId") List<UUID> groupId, @Param("tenantId") String tenantId,
			@Param("activeFlag") String activeFlag);
}
