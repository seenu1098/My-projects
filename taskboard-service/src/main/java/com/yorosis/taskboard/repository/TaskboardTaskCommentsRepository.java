...
public interface TaskboardTaskCommentsRepository extends JpaRepository<TaskboardTaskComments, UUID> {
	...
	public TaskboardTaskComments findByIdAndTenantIdIgnoreCaseAndActiveFlagIgnoreCase(UUID id, String tenantId,
			String activeFlag);
	...
	public List<TaskboardTaskComments> getTaskboardTaskComments(@Param("id") UUID id,
	...
	public List<TaskboardTaskComments> getTaskboardTaskParentComments(@Param("taskId") UUID taskId,
			@Param("parentCommentId") UUID parentCommentId, @Param("tenantId") String tenantId,
