package com.yorosis.taskboard.config;
...
public class RabbitConfig implements RabbitListenerConfigurer {
	...
	public static final String ACTIVITY_LOG_QUEUE = "activity-logs-queue";
	...
	@Bean
	Queue processQueue() {
		return QueueBuilder.durable(PROCESS_QUEUE).withArgument("x-dead-letter-exchange", "").withArgument("x-dead-letter-routing-key", DEAD_PROCESS_QUEUE)
				.withArgument("x-message-ttl", 600_000).build();
	}
