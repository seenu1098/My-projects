package com.yorosis.taskboard.security;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				.antMatchers("/health/v1/ping", "/taskboard/v1/get/taskboard-by-key/*", "/taskboard/v1/save/taskboard-task", "/app-config/v1/save/*/*/*/*",
						"/taskboard/v1/get/taskboard-task/public/*/*", "/account/v1/public/send-email/save", "/org-apps/v1/get/oauth-url")
