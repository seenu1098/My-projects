...
public interface OrgCustomAttributeRepository extends JpaRepository<OrgCustomAttributes, UUID> {
	...
	public OrgCustomAttributes getAttributeBasedOnAttributeName(@Param("name") String name, @Param("tenantId") String tenantId,
			@Param("activeFlag") String activeFlag);

	@Query("select u from OrgCustomAttributes u where u.tenantId = :tenantId and u.activeFlag=:activeFlag")
	public List<OrgCustomAttributes> getListBasedonTenantIdAndActiveFlag(@Param("tenantId") String tenantId, @Param("activeFlag") String activeFlag);
	...
	public int getListForUserCustomAttributes(@Param("tenantId") String tenantId, @Param("activeFlag") String activeFlag);
}
