...
public interface UserCustomAttributeRepository extends JpaRepository<UserCustomAttributes, UUID> {
	...
	public UserCustomAttributes getAttributeBasedonUserNameAndAttributeName(@Param("id") UUID id, @Param("name") String name,
	...
	public int getListForUserCustomAttributes(@Param("id") UUID id, @Param("tenantId") String tenantId, @Param("activeFlag") String activeFlag);
}
