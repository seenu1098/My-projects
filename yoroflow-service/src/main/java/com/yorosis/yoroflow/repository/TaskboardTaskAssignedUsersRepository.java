...
public interface TaskboardTaskAssignedUsersRepository extends JpaRepository<TaskboardTaskAssignedUsers, UUID> {
	...
	public List<TaskboardTaskAssignedUsers> getAssigneeList(@Param("id") List<UUID> id, @Param("tenantId") String tenantId,
	...
	public List<TaskboardTaskAssignedUsers> getAssigneeListByUserId(@Param("userId") List<UUID> userId, @Param("tenantId") String tenantId,
			@Param("activeFlag") String activeFlag);
}
