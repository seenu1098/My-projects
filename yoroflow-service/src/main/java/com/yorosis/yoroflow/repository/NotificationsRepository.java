...
public interface NotificationsRepository extends JpaRepository<Notifications, UUID> {
	...
	public List<Notifications> getDeleteUserNotifications(@Param("toId") List<UUID> toId, @Param("taskboardTaskId") UUID taskboardTaskId,
	...
	public Notifications checkNotifications(@Param("toId") UUID toId, @Param("groupId") UUID groupId, @Param("fromId") UUID fromId, @Param("taskId") UUID taskId,
			@Param("tenantId") String tenantId);
	...
	public List<UUID> checkNotificationsForTaskboardAssign(@Param("toId") List<UUID> toId, @Param("fromId") UUID fromId, @Param("taskboardTaskId") UUID taskboardTaskId,
			@Param("tenantId") String tenantId);
}
