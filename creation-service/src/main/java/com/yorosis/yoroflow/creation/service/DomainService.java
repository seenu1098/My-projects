...
public class DomainService {
	...
	public String getAssignedTenantId(String emailId) throws YoroappsException {
		...
		Customers customer = customersRepository.findByActualDomainNameIgnoreCaseAndActiveFlagIgnoreCase(domain, YoroappsConstants.YES);
		if (customer == null) {
			customer = customersRepository.findByAllowedDomainNamesContainingIgnoreCaseAndActiveFlagIgnoreCase(domain, YoroappsConstants.YES);
		}
