...
export class GridService {
  gridUrl = environment.renderingBaseUrl + '/grids/v1/get-headers/';
  gridDataPaginatioUrl = environment.renderingBaseUrl + '/grids/v1/get-grid-data';
  gridExcelDataUrl = environment.renderingBaseUrl + '/grids/v1/get-excel-file/';
  ...
  getGridData(paginatioVO: PaginationVO) {
    ...
    return this.http.post(this.gridDataPaginatioUrl, paginatioVO, this.tokenHeaderService.getHeader());
  }
}
